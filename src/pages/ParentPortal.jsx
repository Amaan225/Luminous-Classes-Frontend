...
function ParentPortal() {
  ...
  try {
    ...
    alert("Job posted successfully! Tutors will contact you soon.");
    setFormData({ parentName: '', contactNumber: '', studentGrade: '', subject: '', location: '', salary: '' });
  } catch (error) {
