    ...
    <div className="min-h-screen bg-[#f3f1ec] text-[#2C1810] font-sans selection:bg-[#2C1810] selection:text-[#FDF8E7] p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#f0e4cc] p-8 md:p-12 border-4 border-[#2C1810] shadow-[12px_12px_0px_rgba(44,24,16,1)] relative">
          ...
          {/* Vintage Stamp */}
          <div className="absolute top-4 right-4 md:top-8 md:right-8 border-4 border-[#2C1810] px-2 py-1 transform rotate-6 opacity-80 hidden sm:block">
            <span className="font-black uppercase tracking-widest text-xs">LEGAL MANIFEST</span>
          </div>

          <h1 className="text-4xl md:text-5xl font-black uppercase tracking-widest text-[#2C1810] mb-12 border-b-8 border-[#2C1810] pb-4 inline-block">
            Terms & Conditions
          </h1>
          ...
          <div className="space-y-10">
            ...
            <section className="relative">
              ...
              <div className="pl-4">
                ...
                <p className="font-bold text-sm md:text-base tracking-wide leading-relaxed text-[#2C1810]/80">
                  Welcome to Tutor49. By using our platform, you agree to these terms. We act as a direct connection board between parents and independent university tutors.
                </p>
              </div>
            </section>
            ...
            <section className="relative">
              ...
              <div className="pl-4">
                ...
                <p className="font-bold text-sm md:text-base tracking-wide leading-relaxed text-[#2C1810]/80">
                  While we manually verify college IDs, Tutor49 is a matching platform and is not liable for the conduct, safety, or academic outcomes of the engagements. Parents and tutors are explicitly expected to exercise their own due diligence before finalizing any home tuition agreements.
                </p>
              </div>
            </section>
          ...
          <div className="mt-16 pt-8 border-t-4 border-dashed border-[#2C1810] flex justify-between items-end">
            <div>
